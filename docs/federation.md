...
!!!info
    ...
    Instances of Reactor `Flux<T>` are not supported. When you want to return a list, we suggest using [`Flux#collectList`](https://projectreactor.io/docs/core/release/api/reactor/core/publisher/Flux.html#collectList--).
